...
(function (endtask) {
    ...
    function test() {
        ...
        let i = 3;
        let x = endtask.allesInBewegungArray[i].typ;
        console.log(x);
        return x;
    }
    ...
    function update() {
        ...
        endtask.punktzahlEintragen(endtask.punktzahlBerechnen(test())); //Hier muss der Typ der Klasse die gefressen wurde mittels ...[i].typ übergebenwerden
