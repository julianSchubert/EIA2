...
if (process.env.NODE_ENV == "production") {
    ...
    databaseURL = "mongodb+srv://julian:passwort@eia2-6f4gn.mongodb.net/EIA2";
    databaseName = "EIA2";
}
...
export function search(_callback: Function, _gesuchtenummer: string): void {
    ...
    students.find({ "matrikel": gn }).toArray(prepareAnswer); //students ist oben schon definiert und zugewiesen
